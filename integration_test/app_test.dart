...
void main() {
  ...
  group('Auth E2E Test', () {
    testWidgets('deve realizar login', (tester) async {
      ...
      await tester.enterText(emailField, 'annep.valentim@gmail.com');
      await tester.enterText(passwordField, 'Geforce2155.');
      await tester.pump();
    ...
    testWidgets('deve realizar cadastro', (tester) async {
      ...
      await tester.enterText(emailField, 'annep.valentim@gmail.com');
      await tester.enterText(passwordField, 'Geforce2155.');
      await tester.enterText(confirmPasswordField, 'Geforce2155.');
      await tester.enterText(usernameField, 'Anne');
      await tester.enterText(
        avatarUrlField,
        'https://avatars.githubusercontent.com/anne-pinho',
      );
      await tester.pump();
